...
namespace Property_Sales_Final_Project.Areas.Identity.Pages.Account
{
    ...
    public class RegisterPropertyAdminModel : PageModel
    {
        private readonly SignInManager<IdentityUser> _signInManager;
        private readonly UserManager<IdentityUser> _userManager;
        private readonly ILogger<RegisterPropertyAdminModel> _logger;
        private readonly IEmailSender _emailSender;
        private RoleManager<IdentityRole> _roleManager;
       

        public RegisterPropertyAdminModel(
            UserManager<IdentityUser> userManager,
            SignInManager<IdentityUser> signInManager,
            ILogger<RegisterPropertyAdminModel> logger,
            IEmailSender emailSender,
            Property_Sales_IdentityContext dataContext
            )
        {
